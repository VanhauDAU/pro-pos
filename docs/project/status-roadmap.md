...
- Unit: `18/18`; Worker integration: `5 files / 26 tests`; migration `0005 → 0007`: pass.
...
| Database schema          | `COMPLETE`    | 7 migrations cho identity, catalog, POS, billing, Access bridge, hardening và Owner location | Migration mới theo feature; kiểm tra upgrade path mỗi release        |
