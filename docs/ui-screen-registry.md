...
| Owner product list   | User-provided Sapo product list reference, selected MVP fields                                       | loading/list/search/multi-filter/empty/error      | desktop/tablet/mobile | IN_PROGRESS | PRO-017     |
