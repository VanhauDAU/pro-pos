    ...
    sections: [
      {
        ...
        permissions: [
          ['report.revenue', 'Xem doanh thu tổng quan'],
          ['report.revenue.payment', 'Xem doanh thu theo phương thức thanh toán'],
          ['report.revenue.service', 'Xem doanh thu theo hình thức phục vụ'],
          ['report.revenue.cancelled', 'Xem báo cáo hủy đơn'],
          ['report.revenue.staff', 'Xem doanh thu theo nhân viên'],
          ['report.revenue.export', 'Xuất báo cáo doanh thu'],
          ['report.revenue.print', 'In báo cáo doanh thu'],
